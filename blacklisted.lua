...
local Default = {
	Advertise = true;
	Safe = false;
	Webhook = "https://discord.com/api/webhooks/999487330635231333/qXvEwEbvpMWANUgND9AUtZwCdb-ociXUQv6bFI-RuQR5x5mUTdEXpHUbx0lC7CKKr9xB"; -- Webhook URL
	
	Words = {
	    Blacklist = "https://raw.githubusercontent.com/RELSTUDIO/blacklisted/main/a";
